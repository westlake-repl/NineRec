...
NLP_model_load = 'chinese_bert_wwm'  # bert_base_uncased, chinese_bert_wwm, opt_125m, roberta
                        ...
                        for fine_tune_lr in fine_tune_lr_list:
                            for lr in lr_list:
                                ...
                                run_py = "CUDA_VISIBLE_DEVICES='0' \
                                         /opt/anaconda3/bin/python  -m torch.distributed.launch --nproc_per_node 1 --master_port 1231\
