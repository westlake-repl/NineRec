...
def bulid_dataloader(config,dataload):
    ...
    dataset_dict = {
        ...
        'YTDNN': (('SampleTwoTowerTrainDataset','sampletower_train_collate'), 'SeqEvalDataset', 'seq_eval_collate'),
        'FM': (('SampleOneTowerTrainDataset','sampletower_train_collate'), 'SeqEvalDataset', 'seq_eval_collate'),
        'MODSSM': ('MOPairTrainDataset', 'PairEvalDataset', 'pair_eval_collate'),
        ...
        'CuratorNet': ('TwoTowerTrainDataset', 'SeqEvalDataset', 'seq_eval_collate'),
        'DVBPR': ('MOPairTrainDataset', 'PairEvalDataset', 'pair_eval_collate'),
        'ACF': ('ACFTrainDataset', 'ACFEvalDataset', 'seq_eval_collate'),
      ...
      'MOBERT4Rec2': ('MOBERT4RecTrainDataset2', 'SeqEvalDataset','seq_eval_collate'),
        'MOYTDNN': (('MOSampleTwoTowerTrainDataset','mosampletower_train_collate'), 'SeqEvalDataset', 'seq_eval_collate'),
