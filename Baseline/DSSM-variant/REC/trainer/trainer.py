...
class Trainer(object):
    ...
    def _build_optimizer(self):
        if self.optim_args:
            ...
            modal_decay_params = []
            recsys_decay_params = []
            decay_check_name = None  #一般设为None
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None, show_progress=False): 
        ...
        for batch_idx, data in enumerate(iter_data):
            ...
            # else:
            #     id_data, modal_data = data
            #     data = self.to_device(data)
            #     sub1 = id_data[:860], modal_data[:860]
            #     #sub1 = self.to_device(sub1)           
            #     loss1 = self.model(sub1) 
            #     sub2 = id_data[860:], modal_data[860:]
            #     #sub2 = self.to_device(sub2)           
            #     loss2 = self.model(sub2)
            #     losses = loss1+loss2        
            #     total_loss = total_loss + losses.item()
