                        ...
                        for fine_tune_lr in fine_tune_lr_list:
                            for lr in lr_list:
                                label_screen = '{}_bs{}_ed{}_bn{}_lr{}_Flr{}_dp{}_L2r{}_L2m{}'.format(
                                  item_tower, batch_size, embedding_dim, block_num, lr, fine_tune_lr,
                                  drop_rate, l2_weight_R, l2_weight_M)

                                run_py = "CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6,7' \
                                         /opt/anaconda3/bin/python  -m torch.distributed.launch --nproc_per_node 8 --master_port 1231\
