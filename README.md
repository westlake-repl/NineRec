...
We have released all data (text and images) for the 9 downstream tasks as well as the source-domain text data for Bili_500K. We will provide access to the full source dataset (image and Bili_2M) very soon. If you are urgent about the entire source dataset, please email the corresponding author.
